...
public class BSAFileSetWithStatus extends ArrayList<ArchiveFile>
{
	 ...
	 * @param sopErrOnly 
	 */
	public BSAFileSetWithStatus(String rootFilename, boolean loadSiblingBsaFiles, boolean loadNodes)
	{
		this(new String[] { rootFilename }, loadSiblingBsaFiles, loadNodes);
	}

	public BSAFileSetWithStatus(String[] rootFilenames, boolean loadSiblingBsaFiles, boolean loadNodes)
	{
